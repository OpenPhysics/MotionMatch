...
import { FLAT_RECTANGULAR_BUTTON_OPTIONS } from "./MotionMatchButtonOptions.js";
...
export const SIM_SLIDER_OPTIONS = {
  ...
  trackFillEnabled: MotionMatchColors.textColorProperty,
 ...
 * the tick/border use {@link MotionMatchColors.textColorProperty} (near-white in default
 * mode). Do not use {@link MotionMatchColors.controlSurfaceColorProperty} here — that
...
export const SIM_CHECKBOX_OPTIONS = {
  ...
  spacing: 4,
  checkboxColor: MotionMatchColors.textColorProperty,
  checkboxColorBackground: MotionMatchColors.panelBackgroundColorProperty,
