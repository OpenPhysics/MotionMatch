...
import { MotionSensorScreenSummaryContent } from "./MotionSensorScreenSummaryContent.js";

export type MotionSensorScreenViewOptions = ScreenViewOptions;
...
export class MotionSensorScreenView extends ScreenView {
  public constructor(model: MotionSensorModel, providedOptions?: MotionSensorScreenViewOptions) {
    ...
    // it the same way. See MotionSensorScreenSummaryContent for the four content regions.
    ...
    const placeholderText = new Text("Motion Sensor", {
  ...
  //   [model.stateProperty],
  //   (state) => `State: ${state}`,
  // ); // → pass as currentDetailsContent in MotionSensorScreenSummaryContent
